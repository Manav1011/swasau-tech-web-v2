              ...
              <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                  ...
                  <div>
                      ...
                      <li>
                          ...
                          rel="noreferrer"
                          target="_blank"
                          className="text-black-700 transition hover:text-black-700/75"
                          >
                  ...
                  <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                      ...
                      <div className="text-center sm:text-left">
                      <p className="text-lg font-medium text-black-900">Helpful Links</p>
                      ...
                      <div className="text-center sm:text-left">
                      <p className="text-lg font-medium text-black-900">Contact Us</p>
                  ...
                  <div className="text-center sm:flex sm:justify-between sm:text-left">
                      ...
                      <a
                          className="inline-block text-black-600 underline transition hover:text-black-600/75"
                          href="/"
                      >
                          Terms & Conditions
                      </a>
