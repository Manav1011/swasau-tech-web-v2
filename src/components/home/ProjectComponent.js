...
function ProjectComponent({project}) {    
  return (
    <figure className="m-5 shadow-gray-900	rounded-md bg-clip-padding p-10 bg-gray-400 border border-gray-100  flex backdrop-filter backdrop-blur-sm bg-opacity-20 flex-col items-center justify-center p-8 text-center shadow-gray-500 rounded-t-lg md:rounded-t-none md:rounded-ss-lg">            
