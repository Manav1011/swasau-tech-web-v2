...
function TeamMemberCard(props) {
  ...
  return (
    <div className={`${inView ? "right-left" : null} hover:scale-110 transition ease-in-out delay-100 duration-300 mb-10 text-center text-gray-500 dark:text-gray-400`} ref={myref}>
