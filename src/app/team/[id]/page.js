                 ...
                 <div className="flex flex-col sm:w-1/3">
                     ...
                     <div className="flex">
                         ...
                         <a className="text-gray-700 hover:text-orange-600"
                             ...
                             target="_blank" href={member.linkedin ?? member.linkedin}>
                     ...
                     <ul className="list-disc ml-2">
                         {member.skills ?? member.skills.map((e,i) => (
                             <li className="" key={i}>
                             <div className="">{e}</div>
                             </li>
                         ))}
                     ...
                     <div className="flex flex-col space-y-1">
                        {member.educationBackground && member.educationBackground.map((education, index) => (
